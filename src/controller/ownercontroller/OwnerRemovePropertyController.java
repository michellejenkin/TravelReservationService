...
public class OwnerRemovePropertyController implements Initializable {
    ...
    public void initialize(URL arg0, ResourceBundle arg1) {
        ...
        String selectStr = String.format("select view_properties.property_name, description,  view_properties.capacity, address from view_properties natural join property where Owner_Email like '%s'", ownerEmail);
